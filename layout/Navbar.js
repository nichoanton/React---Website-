  ...
  return (
    <div className={classes.navigation}>
      <Nav defaultActiveKey="/home" as="ul">
        ...
        <Nav.Item as="li">
          <Nav.Link className={classes.links} href="/pricing" eventKey="link-1">Pricing</Nav.Link>
        </Nav.Item>
        <Nav.Item as="li">
          <Nav.Link className={classes.links} href="/support" eventKey="link-2">Support</Nav.Link>
        </Nav.Item>
        <Nav.Item as="li">
